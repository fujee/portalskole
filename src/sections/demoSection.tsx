    ...
    <div id="demo" className="bg-transparent pt-24 pb-24">
      <div className="container mx-auto">
        ...
        <h2 className="mt-10 text-1xl font-bold text-black dark:text-white">
          {t('Погледајте како Портал Школе може трансформисати рад организације из перспективе Министарства просвете, школе и крајњих корисника (ученика и родитеља).')}
        </h2>

                ...
                <div className="container mx-auto px-5 lg:px-0">
                    ...
                    <div className="w-full grid grid-cols-1 lg:grid-cols-2 mt-20">
                        ...
                        <div className="px-8 lg:px-24">
                            <img loading="lazy" decoding="async" src={ministarstvo} alt={t('Министарство просвете')} className="mb-10" />
                            ...
                            <div className="flex justify-start items-center mt-10">
                                <div className="w-[64px] h-[64px] overflow-hidden rounded-full flex-none">
                                    <img loading="lazy" decoding="async" src={ana} alt={t('Ана Поповић')} className="w-full h-auto object-cover" />
                                </div>
                                <div className="ms-5">
